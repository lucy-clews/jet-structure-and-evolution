...
print(os.path.basename(hp[batch_number]).split('/')[5]) #prints if in spring or Fall


for x in glob.glob(path+'/ridges/*_ridge1.txt'):
    names.append(os.path.basename(x).split('_')[0])
    print('Gathered sources in that hp')
